...
int64_t GetSporkValue(int nSporkID)
{
    ...
    if (mapSporksActive.count(nSporkID)) {
        ...
        if (nSporkID == SPORK_3_ZELNODE_BENCHMARKD_ENFORCEMENT) r = SPORK_3_ZELNODE_BENCHMARKD_ENFORCEMENT_DEFAULT;
...
int CSporkManager::GetSporkIDByName(std::string strName)
{
    ...
    if (strName == "SPORK_3_ZELNODE_BENCHMARKD_ENFORCEMENT") return SPORK_3_ZELNODE_BENCHMARKD_ENFORCEMENT;
...
std::string CSporkManager::GetSporkNameByID(int id)
{
    ...
    if (id == SPORK_3_ZELNODE_BENCHMARKD_ENFORCEMENT) return "SPORK_3_ZELNODE_BENCHMARKD_ENFORCEMENT";
