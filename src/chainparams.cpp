...
public:
    CMainParams() {
        ...
        vecBenchmarkingPublicKeys[3] = std::make_pair("0437d58236a849ebe0e6558c1517e1f5c56749e04a2f7a7daedd4ef7c9fb6a773f32a33fe5ddad88b9af3ff496ee5ce79ce245c258bafa4e8d287baa3d54c6c65f", 1698861600); // Wed Nov 01 2023 18:00:00 UTC
...
public:
    CTestNetParams() {
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            (0, consensus.hashGenesisBlock)
            (126, uint256S("0x000051aae1d60721a7489ef959dbf50f59bd7a7ba15b7ddbd15116309470927e"))
            (251, uint256S("0x001319f1f26508de29e9e05d615a5cd49a8a97c0e5f4037bbf6ef25b8a40b450")),
            1692637174,  // * UNIX timestamp of last checkpoint block
