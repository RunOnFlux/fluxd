...
// Explicit instantiations for libzelcash::PaymentAddress
template bool CZCEncoding<libzelcash::PaymentAddress,
                          CChainParams::ZCPAYMENT_ADDRRESS,
                          libzelcash::SerializedPaymentAddressSize>::Set(const libzelcash::PaymentAddress& addr);
template libzelcash::PaymentAddress CZCEncoding<libzelcash::PaymentAddress,
                                              CChainParams::ZCPAYMENT_ADDRRESS,
                                              libzelcash::SerializedPaymentAddressSize>::Get() const;

// Explicit instantiations for libzelcash::ViewingKey
template bool CZCEncoding<libzelcash::ViewingKey,
                          CChainParams::ZCVIEWING_KEY,
                          libzelcash::SerializedViewingKeySize>::Set(const libzelcash::ViewingKey& vk);
template libzelcash::ViewingKey CZCEncoding<libzelcash::ViewingKey,
                                          CChainParams::ZCVIEWING_KEY,
                                          libzelcash::SerializedViewingKeySize>::Get() const;

// Explicit instantiations for libzelcash::SpendingKey
template bool CZCEncoding<libzelcash::SpendingKey,
                          CChainParams::ZCSPENDING_KEY,
                          libzelcash::SerializedSpendingKeySize>::Set(const libzelcash::SpendingKey& sk);
template libzelcash::SpendingKey CZCEncoding<libzelcash::SpendingKey,
                                           CChainParams::ZCSPENDING_KEY,
                                           libzelcash::SerializedSpendingKeySize>::Get() const;
