...
JSDescription::JSDescription(ZCJoinSplit& params,
            ...
            const boost::array<libzelcash::JSInput, ZC_NUM_JS_INPUTS>& inputs,
            const boost::array<libzelcash::JSOutput, ZC_NUM_JS_OUTPUTS>& outputs,
            CAmount vpub_old,
            CAmount vpub_new,
            bool computeProof,
...
{
    boost::array<libzelcash::Note, ZC_NUM_JS_OUTPUTS> notes;
