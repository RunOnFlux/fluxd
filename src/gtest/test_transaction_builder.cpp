...
TEST(TransactionBuilder, TransparentToSapling)
{
    ...
    EXPECT_TRUE(ContextualCheckTransaction(tx, state, Params(), 2, 0, false));
...
TEST(TransactionBuilder, SaplingToSapling) {
    ...
    CValidationState state;
    EXPECT_TRUE(ContextualCheckTransaction(tx, state, Params(), 3, 0, false));
    EXPECT_EQ(state.GetRejectReason(), "");
...
TEST(TransactionBuilder, SproutToSproutAndSapling) {
    ...
    CValidationState state;
    EXPECT_TRUE(ContextualCheckTransaction(tx, state, Params(), 4, 0, false));
    EXPECT_EQ(state.GetRejectReason(), "");
