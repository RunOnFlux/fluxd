...
typedef libzelcash::IncrementalMerkleTree<INCREMENTAL_MERKLE_TREE_DEPTH, libzelcash::SHA256Compress> ZCIncrementalMerkleTree;
typedef libzelcash::IncrementalMerkleTree<INCREMENTAL_MERKLE_TREE_DEPTH_TESTING, libzelcash::SHA256Compress> ZCTestingIncrementalMerkleTree;

typedef libzelcash::IncrementalWitness<INCREMENTAL_MERKLE_TREE_DEPTH, libzelcash::SHA256Compress> ZCIncrementalWitness;
typedef libzelcash::IncrementalWitness<INCREMENTAL_MERKLE_TREE_DEPTH_TESTING, libzelcash::SHA256Compress> ZCTestingIncrementalWitness;
