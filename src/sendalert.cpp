...
void ThreadSendAlert()
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "Your client version 2.0.0 is outdated. ZelNodes have been released. Please update to the most recent version of ZelCash (3.0.0 or later).";
