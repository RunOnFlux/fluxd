...
bool AsyncRPCOperation_saplingmigration::main_impl() {
    ...
    libzelcash::SaplingPaymentAddress migrationDestAddress = getMigrationDestAddress(seed);
    ...
    do {
        ...
        for (const CSproutNotePlaintextEntry& sproutEntry : fromNotes) {
            ...
            libzelcash::SproutNote sproutNote = sproutEntry.plaintext.note(sproutEntry.address);
...
libzelcash::SaplingPaymentAddress AsyncRPCOperation_saplingmigration::getMigrationDestAddress(const HDSeed& seed) {
