    ...
    if (fHelp || params.size() < 2 || params.size() > 5)
        throw runtime_error(
            ...
            HelpRequiringPassphrase() + "\n"
                                        ...
                                        "    {\n"
                                        "      \"address\":amount   (numeric) The zelcash address is the key, the numeric amount in " +
    ...
    if (fHelp || params.size() < 2 || params.size() > 4)
        throw runtime_error(
            ...
            strprintf("%s", FormatMoney(ASYNC_RPC_OPERATION_DEFAULT_MINERS_FEE)) + ") The fee amount to attach to this transaction.\n"
                                                                                   ...
                                                                                   "\nExamples:\n" +
            HelpExampleCli("z_sendmany", "\"t1M72Sfpbz1BPpXFHz9m3CdqATR44Jvaydd\" '[{\"address\": \"ztestacadia14jfkht4zc5c68vnn7f0699xh6qtk5su2fkcy88k8jlp0km0m0mw7heyvxp20wr8v3wpsxhgyrxs\" ,\"amount\": 5.0}]'") + HelpExampleRpc("z_sendmany", "\"t1M72Sfpbz1BPpXFHz9m3CdqATR44Jvaydd\", [{\"address\": \"ztestacadia14jfkht4zc5c68vnn7f0699xh6qtk5su2fkcy88k8jlp0km0m0mw7heyvxp20wr8v3wpsxhgyrxs\" ,\"amount\": 5.0}]"));
...
UniValue z_shieldcoinbase(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 2 || params.size() > 4)
        throw runtime_error(
            ...
            "\ntransaction size of " +
            strprintf("%d bytes before Acadia (Sapling,) and %d bytes once Acadia (Sapling) activates.", MAX_TX_SIZE_BEFORE_SAPLING, MAX_TX_SIZE_AFTER_SAPLING) + HelpRequiringPassphrase() + "\n"
                                                                                                                                                                                              "\nArguments:\n"
            ...
            strprintf("%d", SHIELD_COINBASE_DEFAULT_LIMIT) + ") Limit on the maximum number of utxos to shield.  Set to 0 to use node option -mempooltxinputlimit (before Overwinter), or as many as will fit in the transaction (after Overwinter).\n"
                                                             ...
                                                             "}\n"
                                                             "\nExamples:\n" +
            HelpExampleCli("z_shieldcoinbase", "\"t1M72Sfpbz1BPpXFHz9m3CdqATR44Jvaydd\" \"ztestacadia14jfkht4zc5c68vnn7f0699xh6qtk5su2fkcy88k8jlp0km0m0mw7heyvxp20wr8v3wpsxhgyrxs\"") + HelpExampleRpc("z_shieldcoinbase", "\"t1M72Sfpbz1BPpXFHz9m3CdqATR44Jvaydd\", \"ztestacadia14jfkht4zc5c68vnn7f0699xh6qtk5su2fkcy88k8jlp0km0m0mw7heyvxp20wr8v3wpsxhgyrxs\""));
    ...
    if (fHelp || params.size() < 2 || params.size() > 6)
        throw runtime_error(
            ...
            strprintf("%d Sprout or %d Sapling Notes", MERGE_TO_ADDRESS_DEFAULT_SPROUT_LIMIT, MERGE_TO_ADDRESS_DEFAULT_SAPLING_LIMIT) + ") Limit on the maximum number of notes to merge.  Set to 0 to merge as many as will fit in the transaction.\n"
                                                                                                                                        ...
                                                                                                                                        "}\n"
                                                                                                                                        "\nExamples:\n" +
            HelpExampleCli("z_mergetoaddress", "'[\"ANY_SAPLING\", \"t1M72Sfpbz1BPpXFHz9m3CdqATR44Jvaydd\"]' ztestacadia14jfkht4zc5c68vnn7f0699xh6qtk5su2fkcy88k8jlp0km0m0mw7heyvxp20wr8v3wpsxhgyrxs") + HelpExampleRpc("z_mergetoaddress", "[\"ANY_SAPLING\", \"t1M72Sfpbz1BPpXFHz9m3CdqATR44Jvaydd\"], \"ztestacadia14jfkht4zc5c68vnn7f0699xh6qtk5su2fkcy88k8jlp0km0m0mw7heyvxp20wr8v3wpsxhgyrxs\""));
