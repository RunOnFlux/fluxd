...
class CZCPaymentAddress : public CZCEncoding<libzelcash::PaymentAddress, CChainParams::ZCPAYMENT_ADDRRESS, libzelcash::SerializedPaymentAddressSize> {
protected:
...
public:
    ...
    CZCPaymentAddress(const libzelcash::PaymentAddress& addr) { Set(addr); }
};

class CZCViewingKey : public CZCEncoding<libzelcash::ViewingKey, CChainParams::ZCVIEWING_KEY, libzelcash::SerializedViewingKeySize> {
protected:
...
public:
    ...
    CZCViewingKey(const libzelcash::ViewingKey& vk) { Set(vk); }
};

class CZCSpendingKey : public CZCEncoding<libzelcash::SpendingKey, CChainParams::ZCSPENDING_KEY, libzelcash::SerializedSpendingKeySize> {
protected:
...
public:
    ...
    CZCSpendingKey(const libzelcash::SpendingKey& addr) { Set(addr); }
};
