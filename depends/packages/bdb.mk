...
# The patched macros live inside #ifdef HAVE_MUTEX_ARM64_GCC_ASSEMBLY, so the
# patch is applied on every host but only changes code on aarch64.
$(package)_patches=arm64-mutex.patch
...
define $(package)_preprocess_cmds
  patch -p1 < $($(package)_patch_dir)/arm64-mutex.patch && \
