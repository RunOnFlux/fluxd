...
SPROUT_URL="https://gitlab.com/zcashcommunity/params"
...
Failed to fetch the Zelcash zkSNARK parameters!
...
EOF
    ...
    then
        ...
        cat >> "$README_PATH" <<EOF
This directory stores common Zelcash zkSNARK parameters. Note that it is
