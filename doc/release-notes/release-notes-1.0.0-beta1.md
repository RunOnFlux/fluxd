...
Lars-Magnus Skog (1):
      changed module name from "bitcoin" to "Zelcash" in FormatException()
...
Simon (91):
      ...
      Reduce use of global pzelcashParams with private member variable
      Revert "Reduce use of global pzelcashParams with private member variable"
      Replace zelcashParams_ with global.
