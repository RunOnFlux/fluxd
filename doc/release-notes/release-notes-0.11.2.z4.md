...
Alfie John (1):
      Rename libzerocash to libzelcash
...
Jack Grigg (21):
      ...
      Add Zelcash revision to version strings
      Bitcoin -> Zelcash in version and help text
      Add Zelcash Developers to CLI copyright notice
...
Nathan Wilcox (1):
      Fix a test name bug so that ``make cov-zelcash`` correctly runs the ``zelcash-gtest`` binary. Fixes #946.
...
Taylor Hornby (16):
      ...
      Turn on -Werror for the Zelcash build.
