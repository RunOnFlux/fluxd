...
Jack Grigg (31):
      ...
      Rename libbitcoinconsensus to libzelcashconsensus
      Rename bitcoin-tx to zelcash-tx
...
Jay Graber (7):
      Rm bitcoin dev keys from gitian-downloader, add zelcash dev keys
      Rm bips.md
      Update files.md for zelcash
