...
Simon (21):
      ...
      Use -O1 opimitization flag when building libzelcash. Continuation of #1064 and related to #1168.
      Add test for non-malleable txids.  To run just this test: ./zelcash-gtest --gtest_filter="txid_tests*"
...
Taylor Hornby (8):
      ...
      Put hardened stuff in libzelcash CPPFLAGS.
