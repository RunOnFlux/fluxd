...
Jack Grigg (33):
      ...
      Migrate Zelcash-specific code to UniValue
      ...
      Update UniValue includes in Zelcash-specific code
      UniValue::getValues const reference
      Get rid of fPlus argument to FormatMoney in Zelcash-specific code
