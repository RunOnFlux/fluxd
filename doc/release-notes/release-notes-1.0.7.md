...
Jack Grigg (11):
      ...
      Adjust gen-manpages.sh for Zelcash, use in Debian builds
      Regenerate and collate Zelcash manpages, delete Bitcoin ones
      Update release process with gen-manpages.sh
      Adjust blockheaderToJSON() for Zelcash block header
      Adjust fundrawtransaction RPC test for Zelcash
      Re-encode t-addrs in disablewallet.py with Zelcash prefixes
