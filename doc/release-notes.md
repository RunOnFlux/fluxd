...
Upstream of zcash v2.0.4

Sprout note validation bug fixed in wallet
------------------------------------------
We include a fix for a bug in the Zelcashd wallet which could result in Sprout
...
---------------------------------------
Zelcash inherited a bug from upstream Bitcoin Core where both the internal miner
